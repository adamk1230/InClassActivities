...
inquirer.prompt([
  ...
  // Here we give the user a list to choose from.
  {
    ...
    choices: ["Plain", "Pepperoni", "Supreme"],
    name: "pizza"
  },

  {
    type: "checkbox",
    message: "Any additional toppings?",
    choices: ["Sausage", "Mushrooms", "Pineapples"],
    name: "toppings"
  },
...
if (password != user.password){
  ...
  if (user.confirm) {
    ...
    console.log("You like " + user.pizza + " pizzas!");
    console.log(" You have selected " + user.toppings )
    console.log("");
    console.log("==============================================");
